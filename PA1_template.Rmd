...
```{r Numberofsteps plot, echo=TRUE}
library(ggplot2)
...
```{r Numberofsteps mean/median, echo=TRUE}
...
```{r Numberofsteps per interval, echo=TRUE}
...
```{r Maximum steps per interval, echo=TRUE}
...
```{r environment cleanup2, echo=TRUE}
...
```{r calculate missing Data, echo=TRUE}
...
```{r Updated Numberofsteps plot, echo=TRUE}
...
```{r Updated Numberofsteps mean/median, echo=TRUE}
print(paste("Total Steps per day mean =" , format(mean(steps_per_day$x), digits=2, nsmall=2)))
print(paste("Total Steps per day median =" , format(median(steps_per_day$x), digits=2, nsmall=2)))
```
...
```{r Plot of weekdays/weeksdays, echo=TRUE}
